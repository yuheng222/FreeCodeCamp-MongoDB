...
var createAndSavePerson = function(done){
  ...
  person.name = "Bob";
  person.age = 24;
  person.favoriteFoods = ["ramen", "pizza"];
  person.save(function(err, data){
...
var arrayOfPeople = [
  {name: "Jason", age: 19, favoriteFoods: ["soup"]},
  {name: "Sally", age: 25, favoriteFoods: ["banana, chicken"]},
  {name: "Brandon", age: 30, favoriteFoods: ["satay, porridge"]}
];
